...
def main():
   ...
   # input file checking
    ...
    dvs_numpy_steps = args.dvs_numpy_steps
    if dvs_numpy is not None:
        assert (dvs_numpy_diff is not None) and (dvs_numpy_steps is not None), "dvs_numpy_diff should given when use dvs_numpy output"
    ...
    emulator = EventEmulator(
        ...
        dvs_numpy_steps=dvs_numpy_steps,
